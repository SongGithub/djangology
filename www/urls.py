...
urlpatterns = patterns('',
    ...
    url(r'^categories/(?P<slug>[\w-]+)/items$', 
        views.CategoryItemListView.as_view(), name='category-item-list'),

    url(r'^categories/(?P<cat_slug>[\w-]+)/items/(?P<slug>[\w-]+)$', 
        views.CategoryItemUpdateDeleteView.as_view(), name='category-item-update-delete'), 
